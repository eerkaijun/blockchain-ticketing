...
contract Finance is ERC721, Ownable {
    ...
    mapping(address=>uint) investors; // mapping to show number of shares owned by each investor
    ...
    constructor() ERC721("Collateral", "COL") {
        investmentPrice = 30;
    }
